...
namespace G4.WebDriver.Tests
{
    ...
    public class EdgeDriverTests : TestBase<EdgeDriver>
    {
        ...
        public void GetLogInvalidLogTypeTest()
        {
            ...
            // Apply logging preferences to the EdgeDriver options.
        ...
        {
            // Set up EdgeOptions and define log preferences.
            var options = new EdgeOptions();
            ...
            // Invoke the EdgeDriver and retrieve logs of the specified type.
            Invoke(TestContext, options, "Logs.html", (driver) =>
            {
                // Wait for the page to load.
                Thread.Sleep(1500);
        ...
        public void NewEdgeWebDriverServiceTest()
        {
            ...
            // Create a new EdgeWebDriverService instance with the specified binaries path
            var service = new EdgeWebDriverService(binariesPath);

            // Start the Edge WebDriver service
            service.StartService();

            // Verify that the Edge WebDriver service is ready after starting
            Assert.IsTrue(service.Ready, "Edge WebDriver service is not ready after starting.");

            // Dispose of the Edge WebDriver service
            service.Dispose();
        ...
        {
            // Create a new EdgeDriver instance with the path from the test context properties
        ...
        {
            // Create EdgeWebDriverService options with the binaries path from the test context properties
            var options = new EdgeWebDriverService(binariesPath: $"{TestContext.Properties["Grid.Endpoint"]}");

            // Create a new EdgeDriver instance using the specified options
        ...
        {
            // Create an EdgeWebDriverService instance with the binaries path from the test context properties
            var service = new EdgeWebDriverService(binariesPath: $"{TestContext.Properties["Grid.Endpoint"]}");

            // Create a new EdgeDriver instance using the specified service
        ...
        public void NewSessionAddExtensionTest()
        {
            ...
            // Create EdgeOptions and add an extension to it
            var options = new EdgeOptions();
            options.AddExtensions("Binaries/RhinoApiExtensions.crx");

            // Create a new EdgeDriver instance with the specified binaries and options
            var driver = new EdgeDriver(driverBinaries, options);
        ...
        public void SendCdpCommandTest()
        {
            ...
            // Set up EdgeOptions with the remote debugging port
            var options = new EdgeOptions
            {
                Arguments =
                [
